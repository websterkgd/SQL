...
SELECT sub.TennisCourt, CONCAT( sub.firstname,  ' ', sub.surname ) AS FullName
FROM (
SELECT Facilities.name AS TennisCourt, Members.firstname AS firstname, Members.surname AS surname
FROM Bookings
INNER JOIN Facilities ON Bookings.facid = Facilities.facid
AND Facilities.name LIKE  'Tennis Court%'
INNER JOIN Members ON Bookings.memid = Members.memid
) sub
GROUP BY sub.firstname, sub.surname, sub.TennisCourt
ORDER BY FullName
